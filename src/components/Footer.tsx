  ...
  return (
    <footer className="relative pt-20 pb-8 px-4 sm:px-6 lg:px-8 bg-apl-navy overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-apl-saffron/15 rounded-full blur-[100px]" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[200px] bg-apl-gold/8 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-80 h-80 bg-white/10 rounded-full blur-3xl" />
