...
import { ShieldCheck, ExternalLink, SearchCheck } from 'lucide-react';
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="absolute -bottom-20 -right-20 w-60 h-60 bg-apl-gold/20 rounded-full blur-3xl" />
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              {/* Know Your Team Registration Status */}
              <RegisterButton
                label={
                  lang === 'hi'
                    ? 'अपनी टीम का रजिस्ट्रेशन स्टेटस जानें'
                    : 'Know Your Team Registration Status'
                }
                size="xl"
                variant="white"
