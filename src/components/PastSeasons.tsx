      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {pastSeasons.map((s, i) => (
            ...
            >
              <div className="absolute -top-14 -right-14 w-36 h-36 bg-apl-saffron/10 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
