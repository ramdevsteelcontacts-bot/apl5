  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/3 left-0 w-[400px] h-[400px] bg-apl-saffron/6 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-0 w-[400px] h-[400px] bg-apl-gold/6 rounded-full blur-[120px]" />
      </div>
